...
const HeroBanner = () => {
  return (
    <div id="hero-banner" className="relative h-[600px] max-sm:h-fit  text-white">
      ...
      <h1 className=" z-20  relative text-7xl max-sm:text-5xl max-[300px]:text-4xl font-semibold my-2">
         <span className="text-shadow"> Hey I'm </span><span className="linear-text-bg ">Shatish Dangi</span>
        </h1>
        ...
        <div className="flex items-center z-10 gap-5">
                <a href="#"><FaFacebookF size={"2em"} className="hover:text-primary-orange"/></a>
                <a href="#"><FaInstagram size={"2em"} className="hover:text-primary-orange"/></a>
                <a href="#"><FaYoutube size={"2em"} className="hover:text-primary-orange"/></a>
                <a href="#"><FaWhatsapp size={"2em"} className="hover:text-primary-orange"/></a>
        </div>
      </div>
      <div className="flex-1 h flex justify-center max-sm:hidden  relative">
        <img src={photo} alt="photo" className="w-[350px] h-full rounded-lg    object-cover"/>
      </div>
